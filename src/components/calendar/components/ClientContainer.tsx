...
import { DndProviderWrapper } from './Dnd/DndProvider';

import { CalendarHeader } from '@/components/calendar/components/Header/CalendarHeader';
    ...
    const filteredEvents = useMemo(() => {
        return events.filter((event) => {
            ...
            if (view === 'year') {
                ...
                const isUserMatch = selectedUserId === 'all' || event.user.userId === selectedUserId;
