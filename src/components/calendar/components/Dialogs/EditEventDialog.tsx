            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        ...
                        This form only updates the current event state locally for demonstration purposes. If you move an event after editing, some
                        inconsistencies may occur. In a real application, you should submit this form to a backend API to persist the changes.
                    </DialogDescription>
                </DialogHeader>
