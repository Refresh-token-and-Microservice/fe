            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        ...
                        This form is for demonstration purposes only and will not actually create an event. In a real application, submit the form to
                        the backend API to save the event.
                    </DialogDescription>
                </DialogHeader>
